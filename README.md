...
1. 下载 Windows preview 包：[v0.1.5](https://github.com/yuuiwa1551/ai-chat-wingman/releases/tag/v0.1.5)。
...
- [docs/release_notes_v0.1.4.md](docs/release_notes_v0.1.4.md): v0.1.4 发布说明。
- [docs/v0.1.4_followup_plan.md](docs/v0.1.4_followup_plan.md): 风格分析 jobs 化与密钥本地加密计划。
- [docs/release_notes_v0.1.5.md](docs/release_notes_v0.1.5.md): v0.1.5 发布说明。
- [docs/v0.1.5_followup_plan.md](docs/v0.1.5_followup_plan.md): 前端轮询统一与 purge 回执计划。
